...
#     "Isentropic_exponent_measured": y_train,
#     "Isentropic_exponent_predicted": y_train_pred,
...
#     "Isentropic_exponent_measured": y_test,
#     "Isentropic_exponent_predicted": y_test_pred,
...
#
# output_file = "Isentropic_exponent_GBR_train_test_split_by_material.xlsx"
...
print("\nIsentropic Exponent GBDT 完整数据集预测偏差 1%，5%，10%分别为：")
...
all_result = pd.DataFrame({
    ...
    "Isentropic_exponent_measured": y_all_true,
    "Isentropic_exponent_predicted": y_all_pred,
...
feature_importance_file = "Isentropic_exponent_GBDT_feature_importance.xlsx"
...
# 17. 输出模型结构记录
# ============================================================
print("\n当前 Isentropic Exponent GBDT 直接预测模型结构:")
print("Dataset: pure component isentropic exponent 207.xlsx, Sheet1")
print("Target: ordinary Isentropic Exponent")
