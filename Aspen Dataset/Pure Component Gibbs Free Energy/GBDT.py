...
# v_cols = df.columns[41:51]        # 吉布斯自由能列
#
# # 3. 按物质 8:2 划分
...
#     "Gibbs_free_energy_measured (J/mol)": y_train,
#     "Gibbs_free_energy_predicted (J/mol)": y_train_pred,
...
#     "Gibbs_free_energy_measured (J/mol)": y_test,
#     "Gibbs_free_energy_predicted (J/mol)": y_test_pred,
...
#
# output_file = "Gibbs_free_energy_GBR_train_test_split_by_material.xlsx"
...
v_cols = df.columns[41:51]        # 10个 Gibbs free energy 列
...
print("\nGibbs GBDT 完整数据集预测偏差 1%，5%，10%分别为：")
...
all_result = pd.DataFrame({
    ...
    "Gibbs_free_energy_measured (J/mol)": y_all_true,
    "Gibbs_free_energy_predicted (J/mol)": y_all_pred,
...
feature_importance_file = "Gibbs_free_energy_GBDT_feature_importance.xlsx"
...
# 17. 输出模型结构记录
# ============================================================
print("\n当前 Gibbs Free Energy GBDT 直接预测模型结构:")
print("Dataset: Gibbs free energy 205.xlsx, Sheet7")
print("Target: ordinary Gibbs free energy")
