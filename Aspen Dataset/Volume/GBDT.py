...
#
# output_file = "Volume_GBR_train_test_split_by_material.xlsx"
...
print("\nVolume GBDT 完整数据集预测偏差 1%，5%，10%分别为：")
...
feature_importance_file = "Volume_GBDT_feature_importance.xlsx"
