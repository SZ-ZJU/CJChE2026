...
#         enthalpies = row[enthalpy_cols].to_numpy(dtype=float)
#
#         # 基团存在缺失，则跳过该物质
#         if not np.isfinite(Nk).all():
#             continue
#
#         for T, H in zip(temps, enthalpies):
...
# # 14. 保存到 Excel
# # ============================================================
# output_file = "Enthalpy_RF_train_test_split_by_material.xlsx"
#
...
#
# importance_file = "Enthalpy_RF_feature_importance.xlsx"
...
print("\nEnthalpy RF 完整数据集预测偏差 1%，5%，10%分别为：")
