...
# # 3. 数值化
# # ============================================================
# for col in list(group_cols) + list(temp_cols) + list(exergy_cols):
...
#         exergies = row[exergy_cols].to_numpy(dtype=float)
#
#         # 基团有缺失则跳过该物质
#         if not np.isfinite(Nk).all():
#             continue
#
#         for T, exergy in zip(temps, exergies):
#             if not np.isfinite(T) or not np.isfinite(exergy):
#                 continue
#
#             # 特征 = 19个基团 + 温度T
...
#     "Exergy_measured (J/mol)": y_train,
#     "Exergy_predicted (J/mol)": y_train_pred,
...
#     "Exergy_measured (J/mol)": y_test,
#     "Exergy_predicted (J/mol)": y_test_pred,
...
# # 14. 保存到 Excel
# # ============================================================
# output_file = "Exergy_RF_train_test_split_by_material_same_params.xlsx"
#
...
# # 15. 保存特征重要性
# # ============================================================
# feature_names = [f"Group_{i + 1}" for i in range(19)] + ["Temperature"]
#
...
#
# importance_file = "Exergy_RF_feature_importance_same_params.xlsx"
#
...
print("\nExergy RF 完整数据集预测偏差 1%，5%，10%分别为：")
...
all_result = pd.DataFrame({
    ...
    "Exergy_measured (J/mol)": y_all_true,
    "Exergy_predicted (J/mol)": y_all_pred,
...
# 17. 输出模型结构记录
# ============================================================
print("\n当前 Exergy RF 直接预测模型结构:")
print("Dataset: Pure component exergy 205.xlsx, Sheet1")
print("Target: ordinary Exergy")
