...
#
# output_file = "Exergy_GBR_train_test_split_by_material.xlsx"
...
v_cols = df.columns[41:51]        # 10个 Exergy 火用列
...
print("\nExergy GBDT 完整数据集预测偏差 1%，5%，10%分别为：")
...
feature_importance_file = "Exergy_GBDT_feature_importance.xlsx"
