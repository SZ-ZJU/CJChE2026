...
# # 1. 读取数据
# # =========================
# df = pd.read_excel("Transformed_exergy_Dataset.xlsx").copy()
#
# target_col = "Exergy"
...
#
# output_file = "prediction_vs_actual_exergy_train_test_split_by_material.xlsx"
...
print("\nTransformed Exergy RF 完整数据集预测偏差 1%，5%，10%分别为：")
...
feature_importance_file = "Transformed_Exergy_RF_feature_importance.xlsx"
...
# 14. 输出模型结构记录
# =========================
print("\n当前 Transformed Exergy RF 直接预测模型结构:")
print("Dataset: Transformed_exergy_Dataset.xlsx")
print("Target: Exergy")
