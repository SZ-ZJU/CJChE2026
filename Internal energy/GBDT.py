...
#
# output_file = "Internal_energy_GBDT_train_test_split_by_material.xlsx"
...
print("\nInternal Energy GBDT 完整数据集预测偏差 1%，5%，10%分别为：")
...
feature_importance_file = "Internal_energy_GBDT_feature_importance.xlsx"
...
print("\n当前 Internal Energy GBDT 直接预测模型结构:")
print("Dataset: internal energy 207.xlsx, Sheet1")
