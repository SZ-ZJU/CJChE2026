...
# v_cols = df.columns[41:51]       # 目标值列（等熵指数）
#
# # 3. 构建全量点级数据集（保留物质 ID）
...
# ])
#
# output_file = "iex预测结果_基团加温度_RF_train_test_split.xlsx"
...
v_cols = df.columns[41:51]       # 10个目标值列，等熵指数
...
print("\nIsentropic Exponent RF 完整数据集预测偏差 1%，5%，10%分别为：")
...
importance_file = "Isentropic_Exponent_RF_feature_importance.xlsx"
...
# 16. 输出模型结构记录
# ============================================================
print("\n当前 Isentropic Exponent RF 直接预测模型结构:")
