...
# # 3. 数值化
# # ============================================================
# for col in list(group_cols) + list(temp_cols) + list(gibbs_cols):
...
#     "Gibbs_measured (J/mol)": y_train,
#     "Gibbs_predicted (J/mol)": y_train_pred,
...
#     "Gibbs_measured (J/mol)": y_test,
#     "Gibbs_predicted (J/mol)": y_test_pred,
...
# # 14. 保存到 Excel
# # ============================================================
# output_file = "Gibbs_RF_train_test_split_by_material.xlsx"
#
...
#
# importance_file = "Gibbs_RF_feature_importance.xlsx"
#
...
all_result = pd.DataFrame({
    ...
    "Gibbs_measured (J/mol)": y_all_true,
    "Gibbs_predicted (J/mol)": y_all_pred,
...
# 17. 输出模型结构记录
# ============================================================
print("\n当前 Gibbs Free Energy RF 直接预测模型结构:")
print("Dataset: Gibbs free energy 205.xlsx, Sheet6")
