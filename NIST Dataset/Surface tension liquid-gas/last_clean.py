...
# 1. 输入输出文件
# =========================================================
input_file = Path("thermoml_vapor_pressure_Liquid_final_with_Tb.xlsx")
output_file = Path("thermoml_vapor_pressure_Liquid_final_with_Tb_cleaned.xlsx")
...
print("Material_with_Tb 行数:", len(df_material))
