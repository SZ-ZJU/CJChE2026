...
# 才会使用每个物质的数据点数进行兜底切分。
# 蒸汽压数据如果不是固定 8 点，建议保留 material_key 或 original_material_index。
n_points_per_material = 8

# 输出文件
mapping_output = Path("vp_pubchem_cid_mapping_results.xlsx")

# SDF 输出
sdf_prefix = "vp_pubchem_2d_batch"
combined_sdf_file = Path("vp_pubchem_2d_all.sdf")
