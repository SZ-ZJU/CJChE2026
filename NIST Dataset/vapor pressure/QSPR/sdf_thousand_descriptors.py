...
combined_sdf_file = base_dir / "vp_pubchem_2d_all.sdf"

# 如果没有总 SDF，则自动读取批量 SDF
sdf_batch_pattern = "vp_pubchem_2d_batch_*.sdf"

# PubChem CID 映射文件，来自前一步结构下载脚本
mapping_excel = base_dir / "vp_pubchem_cid_mapping_results.xlsx"
mapping_sheet = "All_Query_Results"

# 输出文件
output_csv = base_dir / "vp_descriptors_mordred_2d.csv"
output_excel = base_dir / "vp_descriptors_mordred_2d.xlsx"
...
def find_sdf_files():
    """
    优先使用 vp_pubchem_2d_all.sdf。
    如果不存在，则读取 vp_pubchem_2d_batch_*.sdf。
    """
...
# python vp_sdf_to_mordred_descriptors.py