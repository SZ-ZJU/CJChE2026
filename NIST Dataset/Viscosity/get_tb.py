...
# 1. 输入输出文件
# =========================================================
input_file = Path("thermoml_viscosity_Liquid_final_n8_Tgt30_manual_remove3.xlsx")
input_sheet = "Final_Selected_Data"

output_file = Path("thermoml_viscosity_Liquid_final_n8_Tgt30_manual_remove3_with_Tb.xlsx")
...
def main():
    ...
    print("Viscosity 数据行数:", len(df_data))
